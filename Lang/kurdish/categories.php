...
*   |     File Desc:     Categories module English language file   
*   +--------------------------------------------
*/

$lang_cat = array(
'Add_new_Cat'	=> 'زیادکردنی بەشی نوێ.',
'Add_sub_cat'	=> 'زیادکردنی نیمچە بەش',
'Edit_cat'	=> 'دەستکاری کردنی ناوی بەش',
'Delete_cat'	=> 'سرینەوەی ھەموو بەشەکان',
'Cats_Available'	=> ':بەشەکانی ئەم مۆدیلە'
);